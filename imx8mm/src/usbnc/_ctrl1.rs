...
#[doc = "Possible values of the field `ULPI_PHY_CLK_EN`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum ULPI_PHY_CLK_ENR {
    #[doc = "Disable"]
    ULPI_PHY_CLK_EN_0,
    #[doc = "Enable"]
    ULPI_PHY_CLK_EN_1,
}
impl ULPI_PHY_CLK_ENR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
    pub fn bit_is_clear(&self) -> bool {
        !self.bit()
    ...
    pub fn bit(&self) -> bool {
        match *self {
            ULPI_PHY_CLK_ENR::ULPI_PHY_CLK_EN_0 => false,
            ULPI_PHY_CLK_ENR::ULPI_PHY_CLK_EN_1 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> ULPI_PHY_CLK_ENR {
        match value {
            false => ULPI_PHY_CLK_ENR::ULPI_PHY_CLK_EN_0,
            true => ULPI_PHY_CLK_ENR::ULPI_PHY_CLK_EN_1,
        }
    }
    #[doc = "Checks if the value of the field is `ULPI_PHY_CLK_EN_0`"]
    #[inline]
    pub fn is_ulpi_phy_clk_en_0(&self) -> bool {
        *self == ULPI_PHY_CLK_ENR::ULPI_PHY_CLK_EN_0
    }
    #[doc = "Checks if the value of the field is `ULPI_PHY_CLK_EN_1`"]
    #[inline]
    pub fn is_ulpi_phy_clk_en_1(&self) -> bool {
        *self == ULPI_PHY_CLK_ENR::ULPI_PHY_CLK_EN_1
    }
}
...
#[doc = "Values that can be written to the field `ULPI_PHY_CLK_EN`"]
pub enum ULPI_PHY_CLK_ENW {
    #[doc = "Disable"]
    ULPI_PHY_CLK_EN_0,
    #[doc = "Enable"]
    ULPI_PHY_CLK_EN_1,
}
impl ULPI_PHY_CLK_ENW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _bits(&self) -> bool {
        match *self {
            ULPI_PHY_CLK_ENW::ULPI_PHY_CLK_EN_0 => false,
            ULPI_PHY_CLK_ENW::ULPI_PHY_CLK_EN_1 => true,
        }
    }
}
#[doc = r" Proxy"]
pub struct _ULPI_PHY_CLK_ENW<'a> {
    w: &'a mut W,
}
impl<'a> _ULPI_PHY_CLK_ENW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: ULPI_PHY_CLK_ENW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    #[doc = "Disable"]
    #[inline]
    pub fn ulpi_phy_clk_en_0(self) -> &'a mut W {
        self.variant(ULPI_PHY_CLK_ENW::ULPI_PHY_CLK_EN_0)
    }
    #[doc = "Enable"]
    #[inline]
    pub fn ulpi_phy_clk_en_1(self) -> &'a mut W {
        self.variant(ULPI_PHY_CLK_ENW::ULPI_PHY_CLK_EN_1)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    #[doc = "Bit 7 - Disable Overcurrent Detection"]
    #[inline]
    ...
    #[doc = "Bit 8 - Polarity of Overcurrent The polarity of OTG1/OTG2 port overcurrent event"]
    #[inline]
    ...
    #[doc = "Bit 9 - Power Polarity This bit should be set according to PMIC Power Pin polarity."]
    #[inline]
    ...
    #[doc = "Bit 10 - Wake-up Interrupt Enable This bit enables or disables the OTG1 wake-up interrupt"]
    #[inline]
    ...
    #[doc = "Bit 14 - Software Wake-up Enable"]
    #[inline]
    ...
    #[doc = "Bit 16 - Wake-up on ID change enable"]
    #[inline]
    ...
    #[doc = "Bit 17 - Wake-up on VBUS change enable"]
    #[inline]
    ...
    #[doc = "Bit 20 - ULPI PHY clock enable"]
    #[inline]
    pub fn ulpi_phy_clk_en(&self) -> ULPI_PHY_CLK_ENR {
        ULPI_PHY_CLK_ENR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 20;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        })
    ...
    #[doc = "Bit 31 - Wake-up Interrupt Request This bit indicates that a wake-up interrupt request is received on the OTG1 port"]
    #[inline]
...
impl W {
    ...
    #[doc = "Bit 20 - ULPI PHY clock enable"]
    #[inline]
    pub fn ulpi_phy_clk_en(&mut self) -> _ULPI_PHY_CLK_ENW {
        _ULPI_PHY_CLK_ENW { w: self }
    }
    #[doc = "Bit 29 - Wake-up on DPDM change enable"]
    #[inline]
