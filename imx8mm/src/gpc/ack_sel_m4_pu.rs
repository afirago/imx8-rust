...
#[doc = r" Value of the field"]
pub struct VPU_H1_PGC_PDN_ACKR {
    bits: bool,
}
impl VPU_H1_PGC_PDN_ACKR {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bit(&self) -> bool {
        self.bits
...
#[doc = r" Proxy"]
pub struct _VPU_H1_PGC_PDN_ACKW<'a> {
    w: &'a mut W,
}
impl<'a> _VPU_H1_PGC_PDN_ACKW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    #[doc = "Bit 0 - Select power down acknowledge signal of MIX PGC as the power down acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 2 - Select power down acknowledge signal of MIPI PGC as the power down acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 3 - Select power down acknowledge signal of PCIE PGC as the power down acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 4 - Select power down acknowledge signal of USB_OTG1 PGC as the power down acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 5 - Select power down acknowledge signal of USB_OTG2 PGC as the power down acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 7 - Select power down acknowledge signal of DDR1 PGC as the power down acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 8 - Select power down acknowledge signal of GPU_2D PGC as the power down acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 9 - Select power down acknowledge signal of GPUMIX PGC as the power down acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 10 - Select power down acknowledge signal of VPUMIX PGC as the power down acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 11 - Select power down acknowledge signal of GPU_3D PGC as the power down acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 12 - Select power down acknowledge signal of DISPMIX PGC as the power down acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 13 - Select power down acknowledge signal of VPU_G1 PGC as the power down acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 14 - Select power down acknowledge signal of VPU_G2 PGC as the power down acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 15 - Select power down acknowledge signal of VPU_H1 PGC as the power down acknowledge for M4 LPM."]
    #[inline]
    pub fn vpu_h1_pgc_pdn_ack(&self) -> VPU_H1_PGC_PDN_ACKR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 15;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        };
        VPU_H1_PGC_PDN_ACKR { bits }
    }
    #[doc = "Bit 16 - Select power down acknowledge signal of MIX PGC as the power up acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 18 - Select power down acknowledge signal of MIPI PGC as the power up acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 19 - Select power down acknowledge signal of PCIE PGC as the power up acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 20 - Select power down acknowledge signal of USB_OTG1 PGC as the power up acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 21 - Select power down acknowledge signal of USB_OTG2 PGC as the power up acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 23 - Select power down acknowledge signal of DDR1 PGC as the power up acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 24 - Select power down acknowledge signal of GPU_2D PGC as the power up acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 25 - Select power down acknowledge signal of GPUMIX PGC as the power up acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 26 - Select power down acknowledge signal of VPUMIX PGC as the power up acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 27 - Select power down acknowledge signal of GPU_3D PGC as the power up acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 28 - Select power down acknowledge signal of DISPMIX PGC as the power up acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 29 - Select power down acknowledge signal of VPU_G1 PGC as the power up acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 30 - Select power down acknowledge signal of VPU_G2 PGC as the power up acknowledge for M4 LPM."]
    #[inline]
    ...
    #[doc = "Bit 31 - Select power down acknowledge signal of VPU_H1 PGC as the power up acknowledge for M4 LPM."]
    #[inline]
...
impl W {
    ...
    #[doc = "Bit 15 - Select power down acknowledge signal of VPU_H1 PGC as the power down acknowledge for M4 LPM."]
    #[inline]
    pub fn vpu_h1_pgc_pdn_ack(&mut self) -> _VPU_H1_PGC_PDN_ACKW {
        _VPU_H1_PGC_PDN_ACKW { w: self }
    }
    #[doc = "Bit 16 - Select power down acknowledge signal of MIX PGC as the power up acknowledge for M4 LPM."]
    #[inline]
