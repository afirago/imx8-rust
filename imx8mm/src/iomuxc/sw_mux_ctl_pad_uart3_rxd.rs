...
impl super::SW_MUX_CTL_PAD_UART3_RXD {
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad UART3_RXD"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 4 iomux modes to be used for pad: UART3_RXD."]
    #[inline]
