...
impl super::SW_MUX_CTL_PAD_SAI5_RXC {
...
pub enum MUX_MODER {
    #[doc = "Select signal SAI5_RX_BCLK- Configure register IOMUXC_SAI5_RX_BCLK_SELECT_INPUTSelect Input Register for mode ALT0."]
    ALT0,
    #[doc = "Select signal SAI1_TX_DATA\\[1\\]"]
    ALT1,
    #[doc = "Select signal PDM_CLK"]
    ALT4,
    #[doc = "Select signal GPIO3_IO\\[20\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI5_RXC"]
    ENABLED,
}
impl SIONR {
