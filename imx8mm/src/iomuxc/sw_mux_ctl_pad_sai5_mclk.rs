...
impl super::SW_MUX_CTL_PAD_SAI5_MCLK {
...
pub enum MUX_MODER {
    #[doc = "Select signal SAI5_MCLK- Configure register IOMUXC_SAI5_MCLK_SELECT_INPUTSelect Input Register for mode ALT0."]
    ALT0,
    #[doc = "Select signal SAI1_TX_BCLK- Configure register IOMUXC_SAI1_TX_BCLK_SELECT_INPUTSelect Input Register for mode ALT1."]
    ALT1,
    #[doc = "Select signal GPIO3_IO\\[25\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI5_MCLK"]
    ENABLED,
}
impl SIONR {
