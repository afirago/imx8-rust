...
impl super::SW_MUX_CTL_PAD_SAI1_RXD4 {
...
pub enum MUX_MODER {
    #[doc = "Select signal SAI1_RX_DATA\\[4\\]"]
    ALT0,
    #[doc = "Select signal SAI6_TX_BCLK- Configure register IOMUXC_SAI6_TX_BCLK_SELECT_INPUTSelect Input Register for mode ALT1."]
    ALT1,
    #[doc = "Select signal SAI6_RX_BCLK- Configure register IOMUXC_SAI6_RX_BCLK_SELECT_INPUTSelect Input Register for mode ALT2."]
    ALT2,
    #[doc = "Select signal CORESIGHT_TRACE\\[4\\]"]
    ALT4,
    #[doc = "Select signal GPIO4_IO\\[6\\]"]
    ALT5,
    #[doc = "Select mux mode: ALT6 mux port: BOOT_CFG4 of instance: SRC"]
    ALT6_SRC_BOOT_CFG4,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
impl MUX_MODER {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            ...
            MUX_MODER::ALT4 => 4,
            MUX_MODER::ALT5 => 5,
            MUX_MODER::ALT6_SRC_BOOT_CFG4 => 6,
    ...
    pub fn _from(value: u8) -> MUX_MODER {
        match value {
            ...
            4 => MUX_MODER::ALT4,
            5 => MUX_MODER::ALT5,
            6 => MUX_MODER::ALT6_SRC_BOOT_CFG4,
    ...
    #[doc = "Checks if the value of the field is `ALT6_SRC_BOOT_CFG4`"]
    #[inline]
    pub fn is_alt6_src_boot_cfg4(&self) -> bool {
        *self == MUX_MODER::ALT6_SRC_BOOT_CFG4
    }
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI1_RXD4"]
    ENABLED,
}
impl SIONR {
...
impl MUX_MODEW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            ...
            MUX_MODEW::ALT4 => 4,
            MUX_MODEW::ALT5 => 5,
            MUX_MODEW::ALT6_SRC_BOOT_CFG4 => 6,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _MUX_MODEW<'a> {
    ...
    #[doc = "Select mux mode: ALT6 mux port: BOOT_CFG4 of instance: SRC"]
    #[inline]
    pub fn alt6_src_boot_cfg4(self) -> &'a mut W {
        self.variant(MUX_MODEW::ALT6_SRC_BOOT_CFG4)
    }
