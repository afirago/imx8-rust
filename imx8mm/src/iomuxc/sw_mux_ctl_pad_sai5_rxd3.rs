...
impl super::SW_MUX_CTL_PAD_SAI5_RXD3 {
...
pub enum MUX_MODER {
    #[doc = "Select signal SAI5_RX_DATA\\[3\\]- Configure register IOMUXC_SAI5_RX_DATA_SELECT_INPUT_3Select Input Register for mode ALT0."]
    ALT0,
    ...
    ALT3,
    #[doc = "Select signal PDM_BIT_STREAM\\[3\\]- Configure register IOMUXC_PDM_BIT_STREAM_SELECT_INPUT_3Select Input Register for mode ALT4."]
    ALT4,
    #[doc = "Select signal GPIO3_IO\\[24\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI5_RXD3"]
    ENABLED,
}
impl SIONR {
