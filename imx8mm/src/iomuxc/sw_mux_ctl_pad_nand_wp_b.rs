...
impl super::SW_MUX_CTL_PAD_NAND_WP_B {
...
pub enum MUX_MODER {
    #[doc = "Select signal RAWNAND_WP_B"]
    ALT0,
    #[doc = "Select signal USDHC3_CMD"]
    ALT2,
    #[doc = "Select signal GPIO3_IO\\[18\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad NAND_WP_B"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 3 iomux modes to be used for pad: NAND_WP_B."]
    #[inline]
