...
impl super::SW_MUX_CTL_PAD_SAI3_TXFS {
...
pub enum MUX_MODER {
    #[doc = "Select signal SAI3_TX_SYNC"]
    ALT0,
    #[doc = "Select signal GPT1_CAPTURE2"]
    ALT1,
    #[doc = "Select signal SAI5_RX_DATA\\[1\\]- Configure register IOMUXC_SAI5_RX_DATA_SELECT_INPUT_1Select Input Register for mode ALT2."]
    ALT2,
    #[doc = "Select signal SAI3_TX_DATA\\[1\\]"]
    ALT3,
    #[doc = "Select signal UART2_RX"]
    ALT4,
    #[doc = "Select signal GPIO4_IO\\[31\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI3_TXFS"]
    ENABLED,
}
impl SIONR {
