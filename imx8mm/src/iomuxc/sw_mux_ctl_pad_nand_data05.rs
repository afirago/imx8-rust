...
impl super::SW_MUX_CTL_PAD_NAND_DATA05 {
...
pub enum MUX_MODER {
    #[doc = "Select signal RAWNAND_DATA05"]
    ALT0,
    #[doc = "Select signal QSPI_B_DATA\\[1\\]"]
    ALT1,
    #[doc = "Select signal USDHC3_DATA1"]
    ALT2,
    #[doc = "Select signal GPIO3_IO\\[11\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad NAND_DATA05"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 4 iomux modes to be used for pad: NAND_DATA05."]
    #[inline]
