...
impl super::SW_MUX_CTL_PAD_GPIO1_IO05 {
...
pub enum MUX_MODER {
    #[doc = "Select signal GPIO1_IO\\[5\\]"]
    ALT0,
    #[doc = "Select signal M4_NMI"]
    ALT1,
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad GPIO1_IO05"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 3 iomux modes to be used for pad: GPIO1_IO05."]
    #[inline]
