...
impl super::SW_MUX_CTL_PAD_SAI3_RXD {
...
pub enum MUX_MODER {
    #[doc = "Select signal SAI3_RX_DATA\\[0\\]"]
    ALT0,
    #[doc = "Select signal GPT1_COMPARE1"]
    ALT1,
    #[doc = "Select signal SAI5_RX_DATA\\[0\\]- Configure register IOMUXC_SAI5_RX_DATA_SELECT_INPUT_0Select Input Register for mode ALT2."]
    ALT2,
    #[doc = "Select signal UART2_RTS_B- Configure register IOMUXC_UART2_RTS_B_SELECT_INPUTSelect Input Register for mode ALT4."]
    ALT4,
    #[doc = "Select signal GPIO4_IO\\[30\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI3_RXD"]
    ENABLED,
}
impl SIONR {
