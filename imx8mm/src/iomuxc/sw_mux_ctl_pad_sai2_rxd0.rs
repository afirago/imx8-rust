...
impl super::SW_MUX_CTL_PAD_SAI2_RXD0 {
...
pub enum MUX_MODER {
    #[doc = "Select signal SAI2_RX_DATA\\[0\\]"]
    ALT0,
    #[doc = "Select signal SAI5_TX_DATA\\[0\\]"]
    ALT1,
    #[doc = "Select signal UART1_RTS_B- Configure register IOMUXC_UART1_RTS_B_SELECT_INPUTSelect Input Register for mode ALT4."]
    ALT4,
    #[doc = "Select signal GPIO4_IO\\[23\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI2_RXD0"]
    ENABLED,
}
impl SIONR {
