...
impl super::SW_MUX_CTL_PAD_UART3_TXD {
...
pub enum MUX_MODER {
    #[doc = "Select signal UART3_TX"]
    ALT0,
    #[doc = "Select signal UART1_RTS_B- Configure register IOMUXC_UART1_RTS_B_SELECT_INPUTSelect Input Register for mode ALT1."]
    ALT1,
    #[doc = "Select signal USDHC3_VSELECT"]
    ALT2,
    #[doc = "Select signal GPIO5_IO\\[27\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad UART3_TXD"]
    ENABLED,
}
impl SIONR {
