...
impl super::SW_MUX_CTL_PAD_ENET_RD3 {
...
pub enum MUX_MODER {
    #[doc = "Select signal ENET1_RGMII_RD3"]
    ALT0,
    #[doc = "Select signal GPIO1_IO\\[29\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad ENET_RD3"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 2 iomux modes to be used for pad: ENET_RD3."]
    #[inline]
