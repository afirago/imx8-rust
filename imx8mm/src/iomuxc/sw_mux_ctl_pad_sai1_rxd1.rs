...
impl super::SW_MUX_CTL_PAD_SAI1_RXD1 {
...
pub enum MUX_MODER {
    #[doc = "Select signal SAI1_RX_DATA\\[1\\]"]
    ALT0,
    #[doc = "Select signal SAI5_RX_DATA\\[1\\]- Configure register IOMUXC_SAI5_RX_DATA_SELECT_INPUT_1Select Input Register for mode ALT1."]
    ALT1,
    #[doc = "Select signal PDM_BIT_STREAM\\[1\\]- Configure register IOMUXC_PDM_BIT_STREAM_SELECT_INPUT_1Select Input Register for mode ALT3."]
    ALT3,
    #[doc = "Select signal CORESIGHT_TRACE\\[1\\]"]
    ALT4,
    #[doc = "Select signal GPIO4_IO\\[3\\]"]
    ALT5,
    #[doc = "Select mux mode: ALT6 mux port: BOOT_CFG1 of instance: SRC"]
    ALT6_SRC_BOOT_CFG1,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
impl MUX_MODER {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            ...
            MUX_MODER::ALT4 => 4,
            MUX_MODER::ALT5 => 5,
            MUX_MODER::ALT6_SRC_BOOT_CFG1 => 6,
    ...
    pub fn _from(value: u8) -> MUX_MODER {
        match value {
            ...
            4 => MUX_MODER::ALT4,
            5 => MUX_MODER::ALT5,
            6 => MUX_MODER::ALT6_SRC_BOOT_CFG1,
    ...
    #[doc = "Checks if the value of the field is `ALT6_SRC_BOOT_CFG1`"]
    #[inline]
    pub fn is_alt6_src_boot_cfg1(&self) -> bool {
        *self == MUX_MODER::ALT6_SRC_BOOT_CFG1
    }
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI1_RXD1"]
    ENABLED,
}
impl SIONR {
...
impl MUX_MODEW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            ...
            MUX_MODEW::ALT4 => 4,
            MUX_MODEW::ALT5 => 5,
            MUX_MODEW::ALT6_SRC_BOOT_CFG1 => 6,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _MUX_MODEW<'a> {
    ...
    #[doc = "Select mux mode: ALT6 mux port: BOOT_CFG1 of instance: SRC"]
    #[inline]
    pub fn alt6_src_boot_cfg1(self) -> &'a mut W {
        self.variant(MUX_MODEW::ALT6_SRC_BOOT_CFG1)
    }
