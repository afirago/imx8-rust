...
impl super::SW_MUX_CTL_PAD_NAND_CE1_B {
...
pub enum MUX_MODER {
    #[doc = "Select signal RAWNAND_CE1_B"]
    ALT0,
    #[doc = "Select signal QSPI_A_SS1_B"]
    ALT1,
    #[doc = "Select signal USDHC3_STROBE"]
    ALT2,
    #[doc = "Select signal GPIO3_IO\\[2\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad NAND_CE1_B"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 4 iomux modes to be used for pad: NAND_CE1_B."]
    #[inline]
