...
impl super::SW_MUX_CTL_PAD_SAI1_RXFS {
...
pub enum MUX_MODER {
    #[doc = "Select signal SAI1_RX_SYNC- Configure register IOMUXC_SAI1_RX_SYNC_SELECT_INPUTSelect Input Register for mode ALT0."]
    ALT0,
    #[doc = "Select signal SAI5_RX_SYNC- Configure register IOMUXC_SAI5_RX_SYNC_SELECT_INPUTSelect Input Register for mode ALT1."]
    ALT1,
    #[doc = "Select signal CORESIGHT_TRACE_CLK"]
    ALT4,
    #[doc = "Select signal GPIO4_IO\\[0\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI1_RXFS"]
    ENABLED,
}
impl SIONR {
