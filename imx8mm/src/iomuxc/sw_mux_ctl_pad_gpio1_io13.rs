...
impl super::SW_MUX_CTL_PAD_GPIO1_IO13 {
...
pub enum MUX_MODER {
    #[doc = "Select signal GPIO1_IO\\[13\\]"]
    ALT0,
    #[doc = "Select signal USB1_OTG_OC"]
    ALT1,
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad GPIO1_IO13"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 3 iomux modes to be used for pad: GPIO1_IO13."]
    #[inline]
