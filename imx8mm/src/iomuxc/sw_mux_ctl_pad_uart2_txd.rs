...
impl super::SW_MUX_CTL_PAD_UART2_TXD {
...
pub enum MUX_MODER {
    ...
    ALT0,
    #[doc = "Select signal ECSPI3_SS0"]
    ALT1,
    #[doc = "Select signal GPIO5_IO\\[25\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad UART2_TXD"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 3 iomux modes to be used for pad: UART2_TXD."]
    #[inline]
