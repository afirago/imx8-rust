...
impl super::SW_MUX_CTL_PAD_UART4_RXD {
...
pub enum MUX_MODER {
    #[doc = "Select signal UART4_RX"]
    ALT0,
    #[doc = "Select signal UART2_CTS_B"]
    ALT1,
    #[doc = "Select signal PCIE1_CLKREQ_B- Configure register IOMUXC_PCIE1_CLKREQ_B_SELECT_INPUTSelect Input Register for mode ALT2."]
    ALT2,
    #[doc = "Select signal GPIO5_IO\\[28\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad UART4_RXD"]
    ENABLED,
}
impl SIONR {
