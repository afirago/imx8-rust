...
impl super::SW_MUX_CTL_PAD_ENET_TXC {
...
pub enum MUX_MODER {
    #[doc = "Select signal ENET1_RGMII_TXC"]
    ALT0,
    #[doc = "Select signal ENET1_TX_ER"]
    ALT1,
    #[doc = "Select signal GPIO1_IO\\[23\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad ENET_TXC"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 3 iomux modes to be used for pad: ENET_TXC."]
    #[inline]
