...
impl super::SW_MUX_CTL_PAD_SD2_RESET_B {
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SD2_RESET_B"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 2 iomux modes to be used for pad: SD2_RESET_B."]
    #[inline]
