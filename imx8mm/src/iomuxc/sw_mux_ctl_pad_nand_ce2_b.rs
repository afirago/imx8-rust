...
impl super::SW_MUX_CTL_PAD_NAND_CE2_B {
...
pub enum MUX_MODER {
    #[doc = "Select signal RAWNAND_CE2_B"]
    ALT0,
    #[doc = "Select signal QSPI_B_SS0_B"]
    ALT1,
    #[doc = "Select signal USDHC3_DATA5"]
    ALT2,
    #[doc = "Select signal GPIO3_IO\\[3\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad NAND_CE2_B"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 4 iomux modes to be used for pad: NAND_CE2_B."]
    #[inline]
