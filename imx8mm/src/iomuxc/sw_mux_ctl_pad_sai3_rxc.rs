...
impl super::SW_MUX_CTL_PAD_SAI3_RXC {
...
pub enum MUX_MODER {
    #[doc = "Select signal SAI3_RX_BCLK"]
    ALT0,
    #[doc = "Select signal GPT1_CLK"]
    ALT1,
    #[doc = "Select signal SAI5_RX_BCLK- Configure register IOMUXC_SAI5_RX_BCLK_SELECT_INPUTSelect Input Register for mode ALT2."]
    ALT2,
    #[doc = "Select signal UART2_CTS_B"]
    ALT4,
    #[doc = "Select signal GPIO4_IO\\[29\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI3_RXC"]
    ENABLED,
}
impl SIONR {
