...
impl super::SW_MUX_CTL_PAD_SAI1_TXD1 {
...
pub enum MUX_MODER {
    ...
    ALT0,
    #[doc = "Select signal SAI5_TX_DATA\\[1\\]"]
    ALT1,
    #[doc = "Select signal CORESIGHT_TRACE\\[9\\]"]
    ALT4,
    #[doc = "Select signal GPIO4_IO\\[13\\]"]
    ALT5,
    #[doc = "Select mux mode: ALT6 mux port: BOOT_CFG9 of instance: SRC"]
    ALT6_SRC_BOOT_CFG9,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
impl MUX_MODER {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            ...
            MUX_MODER::ALT4 => 4,
            MUX_MODER::ALT5 => 5,
            MUX_MODER::ALT6_SRC_BOOT_CFG9 => 6,
    ...
    pub fn _from(value: u8) -> MUX_MODER {
        match value {
            ...
            4 => MUX_MODER::ALT4,
            5 => MUX_MODER::ALT5,
            6 => MUX_MODER::ALT6_SRC_BOOT_CFG9,
    ...
    #[doc = "Checks if the value of the field is `ALT6_SRC_BOOT_CFG9`"]
    #[inline]
    pub fn is_alt6_src_boot_cfg9(&self) -> bool {
        *self == MUX_MODER::ALT6_SRC_BOOT_CFG9
    }
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI1_TXD1"]
    ENABLED,
}
impl SIONR {
...
impl MUX_MODEW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            ...
            MUX_MODEW::ALT4 => 4,
            MUX_MODEW::ALT5 => 5,
            MUX_MODEW::ALT6_SRC_BOOT_CFG9 => 6,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _MUX_MODEW<'a> {
    ...
    #[doc = "Select mux mode: ALT6 mux port: BOOT_CFG9 of instance: SRC"]
    #[inline]
    pub fn alt6_src_boot_cfg9(self) -> &'a mut W {
        self.variant(MUX_MODEW::ALT6_SRC_BOOT_CFG9)
    }
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 4 iomux modes to be used for pad: SAI1_TXD1."]
    #[inline]
