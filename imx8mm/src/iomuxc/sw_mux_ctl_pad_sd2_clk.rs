...
impl super::SW_MUX_CTL_PAD_SD2_CLK {
...
pub enum MUX_MODER {
    #[doc = "Select signal USDHC2_CLK"]
    ALT0,
    #[doc = "Select signal GPIO2_IO\\[13\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SD2_CLK"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 2 iomux modes to be used for pad: SD2_CLK."]
    #[inline]
