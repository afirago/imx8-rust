...
impl super::SW_MUX_CTL_PAD_I2C4_SCL {
...
pub enum MUX_MODER {
    #[doc = "Select signal I2C4_SCL"]
    ALT0,
    #[doc = "Select signal PWM2_OUT"]
    ALT1,
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad I2C4_SCL"]
    ENABLED,
}
impl SIONR {
