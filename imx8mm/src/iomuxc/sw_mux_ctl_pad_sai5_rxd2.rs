...
impl super::SW_MUX_CTL_PAD_SAI5_RXD2 {
...
pub enum MUX_MODER {
    #[doc = "Select signal SAI5_RX_DATA\\[2\\]- Configure register IOMUXC_SAI5_RX_DATA_SELECT_INPUT_2Select Input Register for mode ALT0."]
    ALT0,
    ...
    ALT2,
    #[doc = "Select signal SAI5_TX_BCLK- Configure register IOMUXC_SAI5_TX_BCLK_SELECT_INPUTSelect Input Register for mode ALT3."]
    ALT3,
    #[doc = "Select signal PDM_BIT_STREAM\\[2\\]- Configure register IOMUXC_PDM_BIT_STREAM_SELECT_INPUT_2Select Input Register for mode ALT4."]
    ALT4,
    #[doc = "Select signal GPIO3_IO\\[23\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI5_RXD2"]
    ENABLED,
}
impl SIONR {
