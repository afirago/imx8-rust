...
impl super::SW_MUX_CTL_PAD_SAI2_TXFS {
...
pub enum MUX_MODER {
    #[doc = "Select signal SAI2_TX_SYNC"]
    ALT0,
    #[doc = "Select signal SAI5_TX_DATA\\[1\\]"]
    ALT1,
    #[doc = "Select signal SAI2_TX_DATA\\[1\\]"]
    ALT3,
    #[doc = "Select signal UART1_CTS_B"]
    ALT4,
    #[doc = "Select signal GPIO4_IO\\[24\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI2_TXFS"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 5 iomux modes to be used for pad: SAI2_TXFS."]
    #[inline]
