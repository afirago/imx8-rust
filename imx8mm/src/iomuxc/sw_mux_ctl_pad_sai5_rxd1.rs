...
impl super::SW_MUX_CTL_PAD_SAI5_RXD1 {
...
pub enum MUX_MODER {
    #[doc = "Select signal SAI5_RX_DATA\\[1\\]- Configure register IOMUXC_SAI5_RX_DATA_SELECT_INPUT_1Select Input Register for mode ALT0."]
    ALT0,
    ...
    ALT2,
    #[doc = "Select signal SAI5_TX_SYNC- Configure register IOMUXC_SAI5_TX_SYNC_SELECT_INPUTSelect Input Register for mode ALT3."]
    ALT3,
    #[doc = "Select signal PDM_BIT_STREAM\\[1\\]- Configure register IOMUXC_PDM_BIT_STREAM_SELECT_INPUT_1Select Input Register for mode ALT4."]
    ALT4,
    #[doc = "Select signal GPIO3_IO\\[22\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI5_RXD1"]
    ENABLED,
}
impl SIONR {
