...
impl super::SW_MUX_CTL_PAD_I2C1_SCL {
...
pub enum MUX_MODER {
    #[doc = "Select signal I2C1_SCL"]
    ALT0,
    #[doc = "Select signal ENET1_MDC"]
    ALT1,
    #[doc = "Select signal GPIO5_IO\\[14\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad I2C1_SCL"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 3 iomux modes to be used for pad: I2C1_SCL."]
    #[inline]
