...
impl super::SW_MUX_CTL_PAD_SAI2_RXFS {
...
pub enum MUX_MODER {
    #[doc = "Select signal SAI2_RX_SYNC"]
    ALT0,
    ...
    ALT2,
    #[doc = "Select signal SAI2_RX_DATA\\[1\\]"]
    ALT3,
    #[doc = "Select signal UART1_TX"]
    ALT4,
    #[doc = "Select signal GPIO4_IO\\[21\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI2_RXFS"]
    ENABLED,
}
impl SIONR {
