...
impl super::SW_MUX_CTL_PAD_SAI1_TXD3 {
...
pub enum MUX_MODER {
    #[doc = "Select signal SAI1_TX_DATA\\[3\\]"]
    ALT0,
    #[doc = "Select signal SAI5_TX_DATA\\[3\\]"]
    ALT1,
    #[doc = "Select signal CORESIGHT_TRACE\\[11\\]"]
    ALT4,
    #[doc = "Select signal GPIO4_IO\\[15\\]"]
    ALT5,
    #[doc = "Select mux mode: ALT6 mux port: BOOT_CFG11 of instance: SRC"]
    ALT6_SRC_BOOT_CFG11,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
impl MUX_MODER {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            ...
            MUX_MODER::ALT4 => 4,
            MUX_MODER::ALT5 => 5,
            MUX_MODER::ALT6_SRC_BOOT_CFG11 => 6,
    ...
    pub fn _from(value: u8) -> MUX_MODER {
        match value {
            ...
            4 => MUX_MODER::ALT4,
            5 => MUX_MODER::ALT5,
            6 => MUX_MODER::ALT6_SRC_BOOT_CFG11,
    ...
    #[doc = "Checks if the value of the field is `ALT6_SRC_BOOT_CFG11`"]
    #[inline]
    pub fn is_alt6_src_boot_cfg11(&self) -> bool {
        *self == MUX_MODER::ALT6_SRC_BOOT_CFG11
    }
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI1_TXD3"]
    ENABLED,
}
impl SIONR {
...
impl MUX_MODEW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            ...
            MUX_MODEW::ALT4 => 4,
            MUX_MODEW::ALT5 => 5,
            MUX_MODEW::ALT6_SRC_BOOT_CFG11 => 6,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _MUX_MODEW<'a> {
    ...
    #[doc = "Select mux mode: ALT6 mux port: BOOT_CFG11 of instance: SRC"]
    #[inline]
    pub fn alt6_src_boot_cfg11(self) -> &'a mut W {
        self.variant(MUX_MODEW::ALT6_SRC_BOOT_CFG11)
    }
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 4 iomux modes to be used for pad: SAI1_TXD3."]
    #[inline]
