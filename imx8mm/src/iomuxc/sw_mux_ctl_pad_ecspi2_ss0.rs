...
impl super::SW_MUX_CTL_PAD_ECSPI2_SS0 {
...
pub enum MUX_MODER {
    #[doc = "Select signal ECSPI2_SS0"]
    ALT0,
    #[doc = "Select signal UART4_RTS_B- Configure register IOMUXC_UART4_RTS_B_SELECT_INPUTSelect Input Register for mode ALT1."]
    ALT1,
    #[doc = "Select signal GPIO5_IO\\[13\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad ECSPI2_SS0"]
    ENABLED,
}
impl SIONR {
