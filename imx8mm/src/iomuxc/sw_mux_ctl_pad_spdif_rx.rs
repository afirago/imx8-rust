...
impl super::SW_MUX_CTL_PAD_SPDIF_RX {
...
pub enum MUX_MODER {
    #[doc = "Select signal SPDIF1_IN"]
    ALT0,
    #[doc = "Select signal PWM2_OUT"]
    ALT1,
    #[doc = "Select signal GPIO5_IO\\[4\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SPDIF_RX"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 3 iomux modes to be used for pad: SPDIF_RX."]
    #[inline]
