...
impl super::SW_MUX_CTL_PAD_SAI3_TXC {
...
pub enum MUX_MODER {
    #[doc = "Select signal SAI3_TX_BCLK"]
    ALT0,
    #[doc = "Select signal GPT1_COMPARE2"]
    ALT1,
    #[doc = "Select signal SAI5_RX_DATA\\[2\\]- Configure register IOMUXC_SAI5_RX_DATA_SELECT_INPUT_2Select Input Register for mode ALT2."]
    ALT2,
    #[doc = "Select signal UART2_TX"]
    ALT4,
    #[doc = "Select signal GPIO5_IO\\[0\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI3_TXC"]
    ENABLED,
}
impl SIONR {
