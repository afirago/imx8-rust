...
impl super::SW_MUX_CTL_PAD_NAND_READY_B {
...
pub enum MUX_MODER {
    #[doc = "Select signal RAWNAND_READY_B"]
    ALT0,
    #[doc = "Select signal USDHC3_RESET_B"]
    ALT2,
    #[doc = "Select signal GPIO3_IO\\[16\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad NAND_READY_B"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 3 iomux modes to be used for pad: NAND_READY_B."]
    #[inline]
