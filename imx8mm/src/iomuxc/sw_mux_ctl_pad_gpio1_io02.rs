...
impl super::SW_MUX_CTL_PAD_GPIO1_IO02 {
...
pub enum MUX_MODER {
    #[doc = "Select signal GPIO1_IO\\[2\\]"]
    ALT0,
    #[doc = "Select signal WDOG1_WDOG_B"]
    ALT1,
    #[doc = "Select signal WDOG1_WDOG_ANY"]
    ALT5,
    #[doc = "Select signal SJC_DE_B"]
    ALT7,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad GPIO1_IO02"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 4 iomux modes to be used for pad: GPIO1_IO02."]
    #[inline]
