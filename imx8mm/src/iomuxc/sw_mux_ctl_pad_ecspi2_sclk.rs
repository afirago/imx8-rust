...
impl super::SW_MUX_CTL_PAD_ECSPI2_SCLK {
...
pub enum MUX_MODER {
    #[doc = "Select signal ECSPI2_SCLK"]
    ALT0,
    #[doc = "Select signal UART4_RX"]
    ALT1,
    #[doc = "Select signal GPIO5_IO\\[10\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad ECSPI2_SCLK"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 3 iomux modes to be used for pad: ECSPI2_SCLK."]
    #[inline]
