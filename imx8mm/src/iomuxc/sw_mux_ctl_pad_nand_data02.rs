...
impl super::SW_MUX_CTL_PAD_NAND_DATA02 {
...
pub enum MUX_MODER {
    #[doc = "Select signal RAWNAND_DATA02"]
    ALT0,
    #[doc = "Select signal QSPI_A_DATA\\[2\\]"]
    ALT1,
    #[doc = "Select signal USDHC3_CD_B- Configure register IOMUXC_USDHC3_CD_B_SELECT_INPUTSelect Input Register for mode ALT2."]
    ALT2,
    #[doc = "Select signal GPIO3_IO\\[8\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad NAND_DATA02"]
    ENABLED,
}
impl SIONR {
