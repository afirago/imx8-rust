...
impl super::SW_MUX_CTL_PAD_SAI5_RXD0 {
...
pub enum MUX_MODER {
    #[doc = "Select signal SAI5_RX_DATA\\[0\\]- Configure register IOMUXC_SAI5_RX_DATA_SELECT_INPUT_0Select Input Register for mode ALT0."]
    ALT0,
    #[doc = "Select signal SAI1_TX_DATA\\[2\\]"]
    ALT1,
    #[doc = "Select signal PDM_BIT_STREAM\\[0\\]- Configure register IOMUXC_PDM_BIT_STREAM_SELECT_INPUT_0Select Input Register for mode ALT4."]
    ALT4,
    #[doc = "Select signal GPIO3_IO\\[21\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI5_RXD0"]
    ENABLED,
}
impl SIONR {
