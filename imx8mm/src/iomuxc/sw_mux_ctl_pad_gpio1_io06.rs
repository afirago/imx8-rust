...
impl super::SW_MUX_CTL_PAD_GPIO1_IO06 {
...
pub enum MUX_MODER {
    #[doc = "Select signal GPIO1_IO\\[6\\]"]
    ALT0,
    #[doc = "Select signal ENET1_MDC"]
    ALT1,
    #[doc = "Select signal USDHC1_CD_B"]
    ALT5,
    #[doc = "Select signal CCMSRCGPCMIX_EXT_CLK3"]
    ALT6,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad GPIO1_IO06"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 4 iomux modes to be used for pad: GPIO1_IO06."]
    #[inline]
