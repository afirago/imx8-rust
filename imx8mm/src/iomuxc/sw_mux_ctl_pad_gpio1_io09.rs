...
impl super::SW_MUX_CTL_PAD_GPIO1_IO09 {
...
pub enum MUX_MODER {
    #[doc = "Select signal GPIO1_IO\\[9\\]"]
    ALT0,
    #[doc = "Select signal ENET1_1588_EVENT0_OUT"]
    ALT1,
    #[doc = "Select signal USDHC3_RESET_B"]
    ALT4,
    #[doc = "Select signal SDMA2_EXT_EVENT\\[0\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad GPIO1_IO09"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 4 iomux modes to be used for pad: GPIO1_IO09."]
    #[inline]
