...
impl super::SW_MUX_CTL_PAD_GPIO1_IO15 {
...
pub enum MUX_MODER {
    #[doc = "Select signal GPIO1_IO\\[15\\]"]
    ALT0,
    #[doc = "Select signal USB2_OTG_OC"]
    ALT1,
    #[doc = "Select signal USDHC3_WP- Configure register IOMUXC_USDHC3_WP_SELECT_INPUTSelect Input Register for mode ALT4."]
    ALT4,
    #[doc = "Select signal PWM4_OUT"]
    ALT5,
    #[doc = "Select signal CCMSRCGPCMIX_CLKO2"]
    ALT6,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad GPIO1_IO15"]
    ENABLED,
}
impl SIONR {
