...
impl super::SW_MUX_CTL_PAD_I2C3_SCL {
...
pub enum MUX_MODER {
    #[doc = "Select signal I2C3_SCL"]
    ALT0,
    #[doc = "Select signal PWM4_OUT"]
    ALT1,
    #[doc = "Select signal GPT2_CLK"]
    ALT2,
    #[doc = "Select signal GPIO5_IO\\[18\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad I2C3_SCL"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 4 iomux modes to be used for pad: I2C3_SCL."]
    #[inline]
