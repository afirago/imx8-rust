...
impl super::SW_MUX_CTL_PAD_ECSPI1_MOSI {
...
pub enum MUX_MODER {
    #[doc = "Select signal ECSPI1_MOSI"]
    ALT0,
    #[doc = "Select signal UART3_TX"]
    ALT1,
    #[doc = "Select signal GPIO5_IO\\[7\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad ECSPI1_MOSI"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 3 iomux modes to be used for pad: ECSPI1_MOSI."]
    #[inline]
