...
impl super::SW_MUX_CTL_PAD_GPIO1_IO07 {
...
pub enum MUX_MODER {
    #[doc = "Select signal GPIO1_IO\\[7\\]"]
    ALT0,
    #[doc = "Select signal ENET1_MDIO- Configure register IOMUXC_ENET1_MDIO_SELECT_INPUTSelect Input Register for mode ALT1."]
    ALT1,
    #[doc = "Select signal USDHC1_WP"]
    ALT5,
    #[doc = "Select signal CCMSRCGPCMIX_EXT_CLK4"]
    ALT6,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad GPIO1_IO07"]
    ENABLED,
}
impl SIONR {
