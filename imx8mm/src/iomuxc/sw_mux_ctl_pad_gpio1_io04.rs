...
impl super::SW_MUX_CTL_PAD_GPIO1_IO04 {
...
pub enum MUX_MODER {
    #[doc = "Select signal GPIO1_IO\\[4\\]"]
    ALT0,
    #[doc = "Select signal USDHC2_VSELECT"]
    ALT1,
    #[doc = "Select signal SDMA1_EXT_EVENT\\[1\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad GPIO1_IO04"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 3 iomux modes to be used for pad: GPIO1_IO04."]
    #[inline]
