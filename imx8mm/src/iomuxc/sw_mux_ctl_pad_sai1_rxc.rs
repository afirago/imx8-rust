...
impl super::SW_MUX_CTL_PAD_SAI1_RXC {
...
pub enum MUX_MODER {
    #[doc = "Select signal SAI1_RX_BCLK"]
    ALT0,
    #[doc = "Select signal SAI5_RX_BCLK- Configure register IOMUXC_SAI5_RX_BCLK_SELECT_INPUTSelect Input Register for mode ALT1."]
    ALT1,
    #[doc = "Select signal CORESIGHT_TRACE_CTL"]
    ALT4,
    #[doc = "Select signal GPIO4_IO\\[1\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI1_RXC"]
    ENABLED,
}
impl SIONR {
