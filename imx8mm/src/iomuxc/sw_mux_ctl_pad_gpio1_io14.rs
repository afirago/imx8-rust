...
impl super::SW_MUX_CTL_PAD_GPIO1_IO14 {
...
pub enum MUX_MODER {
    #[doc = "Select signal GPIO1_IO\\[14\\]"]
    ALT0,
    #[doc = "Select signal USB2_OTG_PWR"]
    ALT1,
    #[doc = "Select signal USDHC3_CD_B- Configure register IOMUXC_USDHC3_CD_B_SELECT_INPUTSelect Input Register for mode ALT4."]
    ALT4,
    #[doc = "Select signal PWM3_OUT"]
    ALT5,
    #[doc = "Select signal CCMSRCGPCMIX_CLKO1"]
    ALT6,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad GPIO1_IO14"]
    ENABLED,
}
impl SIONR {
