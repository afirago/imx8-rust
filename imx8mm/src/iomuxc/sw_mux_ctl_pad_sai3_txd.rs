...
impl super::SW_MUX_CTL_PAD_SAI3_TXD {
...
pub enum MUX_MODER {
    #[doc = "Select signal SAI3_TX_DATA\\[0\\]"]
    ALT0,
    #[doc = "Select signal GPT1_COMPARE3"]
    ALT1,
    #[doc = "Select signal SAI5_RX_DATA\\[3\\]- Configure register IOMUXC_SAI5_RX_DATA_SELECT_INPUT_3Select Input Register for mode ALT2."]
    ALT2,
    #[doc = "Select signal GPIO5_IO\\[1\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI3_TXD"]
    ENABLED,
}
impl SIONR {
