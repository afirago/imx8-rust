...
impl super::SW_MUX_CTL_PAD_NAND_DATA00 {
...
pub enum MUX_MODER {
    #[doc = "Select signal RAWNAND_DATA00"]
    ALT0,
    #[doc = "Select signal QSPI_A_DATA\\[0\\]"]
    ALT1,
    #[doc = "Select signal GPIO3_IO\\[6\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad NAND_DATA00"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 3 iomux modes to be used for pad: NAND_DATA00."]
    #[inline]
