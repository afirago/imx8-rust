...
impl super::SW_MUX_CTL_PAD_UART4_TXD {
...
pub enum MUX_MODER {
    ...
    ALT0,
    #[doc = "Select signal UART2_RTS_B- Configure register IOMUXC_UART2_RTS_B_SELECT_INPUTSelect Input Register for mode ALT1."]
    ALT1,
    #[doc = "Select signal GPIO5_IO\\[29\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad UART4_TXD"]
    ENABLED,
}
impl SIONR {
