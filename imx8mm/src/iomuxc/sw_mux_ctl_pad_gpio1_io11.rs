...
impl super::SW_MUX_CTL_PAD_GPIO1_IO11 {
...
pub enum MUX_MODER {
    #[doc = "Select signal GPIO1_IO\\[11\\]"]
    ALT0,
    #[doc = "Select signal USB2_OTG_ID"]
    ALT1,
    #[doc = "Select signal USDHC3_VSELECT"]
    ALT4,
    #[doc = "Select signal CCMSRCGPCMIX_PMIC_READY"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad GPIO1_IO11"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 4 iomux modes to be used for pad: GPIO1_IO11."]
    #[inline]
