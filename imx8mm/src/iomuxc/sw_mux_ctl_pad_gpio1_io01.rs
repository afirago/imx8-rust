...
impl super::SW_MUX_CTL_PAD_GPIO1_IO01 {
...
pub enum MUX_MODER {
    #[doc = "Select signal GPIO1_IO\\[1\\]"]
    ALT0,
    #[doc = "Select signal PWM1_OUT"]
    ALT1,
    #[doc = "Select signal ANAMIX_REF_CLK_24M"]
    ALT5,
    #[doc = "Select signal CCMSRCGPCMIX_EXT_CLK2"]
    ALT6,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad GPIO1_IO01"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 4 iomux modes to be used for pad: GPIO1_IO01."]
    #[inline]
