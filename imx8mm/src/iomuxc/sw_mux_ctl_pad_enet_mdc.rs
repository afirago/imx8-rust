...
impl super::SW_MUX_CTL_PAD_ENET_MDC {
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad ENET_MDC"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 2 iomux modes to be used for pad: ENET_MDC."]
    #[inline]
