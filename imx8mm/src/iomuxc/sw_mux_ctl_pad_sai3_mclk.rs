...
impl super::SW_MUX_CTL_PAD_SAI3_MCLK {
...
pub enum MUX_MODER {
    #[doc = "Select signal SAI3_MCLK"]
    ALT0,
    #[doc = "Select signal PWM4_OUT"]
    ALT1,
    #[doc = "Select signal SAI5_MCLK- Configure register IOMUXC_SAI5_MCLK_SELECT_INPUTSelect Input Register for mode ALT2."]
    ALT2,
    #[doc = "Select signal GPIO5_IO\\[2\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI3_MCLK"]
    ENABLED,
}
impl SIONR {
