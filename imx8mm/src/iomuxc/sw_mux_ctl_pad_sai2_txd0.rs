...
impl super::SW_MUX_CTL_PAD_SAI2_TXD0 {
...
pub enum MUX_MODER {
    #[doc = "Select signal SAI2_TX_DATA\\[0\\]"]
    ALT0,
    #[doc = "Select signal SAI5_TX_DATA\\[3\\]"]
    ALT1,
    #[doc = "Select signal GPIO4_IO\\[26\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad SAI2_TXD0"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 3 iomux modes to be used for pad: SAI2_TXD0."]
    #[inline]
