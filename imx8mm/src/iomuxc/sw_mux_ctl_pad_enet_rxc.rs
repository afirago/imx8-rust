...
impl super::SW_MUX_CTL_PAD_ENET_RXC {
...
pub enum MUX_MODER {
    #[doc = "Select signal ENET1_RGMII_RXC"]
    ALT0,
    #[doc = "Select signal ENET1_RX_ER"]
    ALT1,
    #[doc = "Select signal GPIO1_IO\\[25\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad ENET_RXC"]
    ENABLED,
}
impl SIONR {
...
impl R {
    ...
    #[doc = "Bits 0:2 - MUX Mode Select Field. Select 1 of 3 iomux modes to be used for pad: ENET_RXC."]
    #[inline]
