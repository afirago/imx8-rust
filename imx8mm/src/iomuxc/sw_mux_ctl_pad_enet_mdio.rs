...
impl super::SW_MUX_CTL_PAD_ENET_MDIO {
...
pub enum MUX_MODER {
    #[doc = "Select signal ENET1_MDIO- Configure register IOMUXC_ENET1_MDIO_SELECT_INPUTSelect Input Register for mode ALT0."]
    ALT0,
    #[doc = "Select signal GPIO1_IO\\[17\\]"]
    ALT5,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
...
pub enum SIONR {
    ...
    DISABLED,
    #[doc = "Force input path of pad ENET_MDIO"]
    ENABLED,
}
impl SIONR {
