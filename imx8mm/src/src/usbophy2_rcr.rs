...
#[doc = "Possible values of the field `OTG2_PHY_RESET`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum OTG2_PHY_RESETR {
    #[doc = "Don't reset USB OTG2 PHY"]
    OTG2_PHY_RESET_0,
    #[doc = "Reset USB OTG2 PHY"]
    OTG2_PHY_RESET_1,
}
impl OTG2_PHY_RESETR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            OTG2_PHY_RESETR::OTG2_PHY_RESET_0 => false,
            OTG2_PHY_RESETR::OTG2_PHY_RESET_1 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> OTG2_PHY_RESETR {
        match value {
            false => OTG2_PHY_RESETR::OTG2_PHY_RESET_0,
            true => OTG2_PHY_RESETR::OTG2_PHY_RESET_1,
        }
    }
    #[doc = "Checks if the value of the field is `OTG2_PHY_RESET_0`"]
    #[inline]
    pub fn is_otg2_phy_reset_0(&self) -> bool {
        *self == OTG2_PHY_RESETR::OTG2_PHY_RESET_0
    }
    #[doc = "Checks if the value of the field is `OTG2_PHY_RESET_1`"]
    #[inline]
    pub fn is_otg2_phy_reset_1(&self) -> bool {
        *self == OTG2_PHY_RESETR::OTG2_PHY_RESET_1
    }
}
...
#[doc = "Values that can be written to the field `OTG2_PHY_RESET`"]
pub enum OTG2_PHY_RESETW {
    #[doc = "Don't reset USB OTG2 PHY"]
    OTG2_PHY_RESET_0,
    #[doc = "Reset USB OTG2 PHY"]
    OTG2_PHY_RESET_1,
}
impl OTG2_PHY_RESETW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _bits(&self) -> bool {
        match *self {
            OTG2_PHY_RESETW::OTG2_PHY_RESET_0 => false,
            OTG2_PHY_RESETW::OTG2_PHY_RESET_1 => true,
        }
    }
}
#[doc = r" Proxy"]
pub struct _OTG2_PHY_RESETW<'a> {
    w: &'a mut W,
}
impl<'a> _OTG2_PHY_RESETW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: OTG2_PHY_RESETW) -> &'a mut W {
        {
    ...
    #[doc = "Don't reset USB OTG2 PHY"]
    #[inline]
    pub fn otg2_phy_reset_0(self) -> &'a mut W {
        self.variant(OTG2_PHY_RESETW::OTG2_PHY_RESET_0)
    }
    #[doc = "Reset USB OTG2 PHY"]
    #[inline]
    pub fn otg2_phy_reset_1(self) -> &'a mut W {
        self.variant(OTG2_PHY_RESETW::OTG2_PHY_RESET_1)
    }
...
impl R {
    ...
    #[inline]
    pub fn otg2_phy_reset(&self) -> OTG2_PHY_RESETR {
        OTG2_PHY_RESETR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 0;
...
impl W {
    ...
    #[doc = "Bit 0 - no description available"]
    #[inline]
    pub fn otg2_phy_reset(&mut self) -> _OTG2_PHY_RESETW {
        _OTG2_PHY_RESETW { w: self }
    }
    #[doc = "Bit 24 - Domain0 assignment control. Effective when dom_en is set to 1."]
    #[inline]
