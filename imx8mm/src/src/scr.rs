...
#[doc = "Possible values of the field `MASK_TEMPSENSE_RESET`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum MASK_TEMPSENSE_RESETR {
    #[doc = "tempsense_reset is masked"]
    MASK_TEMPSENSE_RESET_5,
    #[doc = "tempsense_reset is not masked"]
    MASK_TEMPSENSE_RESET_10,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
impl MASK_TEMPSENSE_RESETR {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bits(&self) -> u8 {
        match *self {
            MASK_TEMPSENSE_RESETR::MASK_TEMPSENSE_RESET_5 => 5,
            MASK_TEMPSENSE_RESETR::MASK_TEMPSENSE_RESET_10 => 10,
            MASK_TEMPSENSE_RESETR::_Reserved(bits) => bits,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: u8) -> MASK_TEMPSENSE_RESETR {
        match value {
            5 => MASK_TEMPSENSE_RESETR::MASK_TEMPSENSE_RESET_5,
            10 => MASK_TEMPSENSE_RESETR::MASK_TEMPSENSE_RESET_10,
            i => MASK_TEMPSENSE_RESETR::_Reserved(i),
        }
    }
    #[doc = "Checks if the value of the field is `MASK_TEMPSENSE_RESET_5`"]
    #[inline]
    pub fn is_mask_tempsense_reset_5(&self) -> bool {
        *self == MASK_TEMPSENSE_RESETR::MASK_TEMPSENSE_RESET_5
    }
    #[doc = "Checks if the value of the field is `MASK_TEMPSENSE_RESET_10`"]
    #[inline]
    pub fn is_mask_tempsense_reset_10(&self) -> bool {
        *self == MASK_TEMPSENSE_RESETR::MASK_TEMPSENSE_RESET_10
    }
}
...
#[doc = "Values that can be written to the field `MASK_TEMPSENSE_RESET`"]
pub enum MASK_TEMPSENSE_RESETW {
    #[doc = "tempsense_reset is masked"]
    MASK_TEMPSENSE_RESET_5,
    #[doc = "tempsense_reset is not masked"]
    MASK_TEMPSENSE_RESET_10,
}
impl MASK_TEMPSENSE_RESETW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _bits(&self) -> u8 {
        match *self {
            MASK_TEMPSENSE_RESETW::MASK_TEMPSENSE_RESET_5 => 5,
            MASK_TEMPSENSE_RESETW::MASK_TEMPSENSE_RESET_10 => 10,
        }
    }
}
#[doc = r" Proxy"]
pub struct _MASK_TEMPSENSE_RESETW<'a> {
    w: &'a mut W,
}
impl<'a> _MASK_TEMPSENSE_RESETW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: MASK_TEMPSENSE_RESETW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "tempsense_reset is masked"]
    #[inline]
    pub fn mask_tempsense_reset_5(self) -> &'a mut W {
        self.variant(MASK_TEMPSENSE_RESETW::MASK_TEMPSENSE_RESET_5)
    }
    #[doc = "tempsense_reset is not masked"]
    #[inline]
    pub fn mask_tempsense_reset_10(self) -> &'a mut W {
        self.variant(MASK_TEMPSENSE_RESETW::MASK_TEMPSENSE_RESET_10)
    }
...
impl R {
    ...
    #[doc = "Bits 4:7 - Mask tempsense_reset source"]
    #[inline]
    pub fn mask_tempsense_reset(&self) -> MASK_TEMPSENSE_RESETR {
        MASK_TEMPSENSE_RESETR::_from({
            const MASK: u8 = 15;
            const OFFSET: u8 = 4;
...
impl W {
    ...
    #[doc = "Bits 4:7 - Mask tempsense_reset source"]
    #[inline]
    pub fn mask_tempsense_reset(&mut self) -> _MASK_TEMPSENSE_RESETW {
        _MASK_TEMPSENSE_RESETW { w: self }
    }
    #[doc = "Bit 24 - Domain0 assignment control. Effective when dom_en is set to 1."]
    #[inline]
