...
#[doc = "Possible values of the field `DISP_RESET`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DISP_RESETR {
    #[doc = "Don't reset dispmix"]
    DISP_RESET_0,
    #[doc = "Reset dispmix"]
    DISP_RESET_1,
}
impl DISP_RESETR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            DISP_RESETR::DISP_RESET_0 => false,
            DISP_RESETR::DISP_RESET_1 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> DISP_RESETR {
        match value {
            false => DISP_RESETR::DISP_RESET_0,
            true => DISP_RESETR::DISP_RESET_1,
        }
    }
    #[doc = "Checks if the value of the field is `DISP_RESET_0`"]
    #[inline]
    pub fn is_disp_reset_0(&self) -> bool {
        *self == DISP_RESETR::DISP_RESET_0
    }
    #[doc = "Checks if the value of the field is `DISP_RESET_1`"]
    #[inline]
    pub fn is_disp_reset_1(&self) -> bool {
        *self == DISP_RESETR::DISP_RESET_1
    }
}
...
#[doc = "Values that can be written to the field `DISP_RESET`"]
pub enum DISP_RESETW {
    #[doc = "Don't reset dispmix"]
    DISP_RESET_0,
    #[doc = "Reset dispmix"]
    DISP_RESET_1,
...
impl DISP_RESETW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            DISP_RESETW::DISP_RESET_0 => false,
            DISP_RESETW::DISP_RESET_1 => true,
        }
    }
}
#[doc = r" Proxy"]
pub struct _DISP_RESETW<'a> {
    w: &'a mut W,
}
impl<'a> _DISP_RESETW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: DISP_RESETW) -> &'a mut W {
        {
    ...
    #[doc = "Don't reset dispmix"]
    #[inline]
    pub fn disp_reset_0(self) -> &'a mut W {
        self.variant(DISP_RESETW::DISP_RESET_0)
    }
    #[doc = "Reset dispmix"]
    #[inline]
    pub fn disp_reset_1(self) -> &'a mut W {
        self.variant(DISP_RESETW::DISP_RESET_1)
    }
...
impl R {
    ...
    #[inline]
    pub fn disp_reset(&self) -> DISP_RESETR {
        DISP_RESETR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 0;
...
impl W {
    ...
    #[doc = "Bit 0 - no description available"]
    #[inline]
    pub fn disp_reset(&mut self) -> _DISP_RESETW {
        _DISP_RESETW { w: self }
    }
    #[doc = "Bit 24 - Domain0 assignment control. Effective when dom_en is set to 1."]
    #[inline]
