...
#[doc = "Possible values of the field `MIPI_DOUBLE_CMPNT`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum MIPI_DOUBLE_CMPNTR {
...
impl MIPI_DOUBLE_CMPNTR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            MIPI_DOUBLE_CMPNTR::MIPI_DOUBLE_CMPNT_0 => false,
            MIPI_DOUBLE_CMPNTR::MIPI_DOUBLE_CMPNT_1 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> MIPI_DOUBLE_CMPNTR {
        match value {
            false => MIPI_DOUBLE_CMPNTR::MIPI_DOUBLE_CMPNT_0,
            true => MIPI_DOUBLE_CMPNTR::MIPI_DOUBLE_CMPNT_1,
        }
    }
    #[doc = "Checks if the value of the field is `MIPI_DOUBLE_CMPNT_0`"]
    #[inline]
    pub fn is_mipi_double_cmpnt_0(&self) -> bool {
        *self == MIPI_DOUBLE_CMPNTR::MIPI_DOUBLE_CMPNT_0
    }
    #[doc = "Checks if the value of the field is `MIPI_DOUBLE_CMPNT_1`"]
    #[inline]
    pub fn is_mipi_double_cmpnt_1(&self) -> bool {
        *self == MIPI_DOUBLE_CMPNTR::MIPI_DOUBLE_CMPNT_1
    }
}
#[doc = r" Value of the field"]
pub struct MIPI_YU_SWAPR {
    bits: bool,
}
impl MIPI_YU_SWAPR {
    #[doc = r" Value of the field as raw bits"]
...
#[doc = "Possible values of the field `DATA_FROM_MIPI`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DATA_FROM_MIPIR {
    #[doc = "Data from parallel sensor"]
    DATA_FROM_MIPI_0,
    #[doc = "Data from MIPI"]
    DATA_FROM_MIPI_1,
}
impl DATA_FROM_MIPIR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
    pub fn bit_is_clear(&self) -> bool {
        !self.bit()
    ...
    pub fn bit(&self) -> bool {
        match *self {
            DATA_FROM_MIPIR::DATA_FROM_MIPI_0 => false,
            DATA_FROM_MIPIR::DATA_FROM_MIPI_1 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> DATA_FROM_MIPIR {
        match value {
            false => DATA_FROM_MIPIR::DATA_FROM_MIPI_0,
            true => DATA_FROM_MIPIR::DATA_FROM_MIPI_1,
        }
    }
    #[doc = "Checks if the value of the field is `DATA_FROM_MIPI_0`"]
    #[inline]
    pub fn is_data_from_mipi_0(&self) -> bool {
        *self == DATA_FROM_MIPIR::DATA_FROM_MIPI_0
    }
    #[doc = "Checks if the value of the field is `DATA_FROM_MIPI_1`"]
    #[inline]
    pub fn is_data_from_mipi_1(&self) -> bool {
        *self == DATA_FROM_MIPIR::DATA_FROM_MIPI_1
    }
}
#[doc = r" Value of the field"]
pub struct LINE_STRIDE_ENR {
    bits: bool,
}
impl LINE_STRIDE_ENR {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bit(&self) -> bool {
        self.bits
...
#[doc = r" Value of the field"]
pub struct MIPI_DATA_FORMATR {
    bits: u8,
}
impl MIPI_DATA_FORMATR {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bits(&self) -> u8 {
        self.bits
...
#[doc = "Values that can be written to the field `MIPI_DOUBLE_CMPNT`"]
pub enum MIPI_DOUBLE_CMPNTW {
    #[doc = "Single component per clock cycle (half pixel per clock cycle)"]
    MIPI_DOUBLE_CMPNT_0,
    #[doc = "Double component per clock cycle (a pixel per clock cycle)"]
    MIPI_DOUBLE_CMPNT_1,
}
impl MIPI_DOUBLE_CMPNTW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _bits(&self) -> bool {
        match *self {
            MIPI_DOUBLE_CMPNTW::MIPI_DOUBLE_CMPNT_0 => false,
            MIPI_DOUBLE_CMPNTW::MIPI_DOUBLE_CMPNT_1 => true,
        }
    }
}
#[doc = r" Proxy"]
pub struct _MIPI_DOUBLE_CMPNTW<'a> {
    w: &'a mut W,
}
impl<'a> _MIPI_DOUBLE_CMPNTW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: MIPI_DOUBLE_CMPNTW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    #[doc = "Single component per clock cycle (half pixel per clock cycle)"]
    #[inline]
    pub fn mipi_double_cmpnt_0(self) -> &'a mut W {
        self.variant(MIPI_DOUBLE_CMPNTW::MIPI_DOUBLE_CMPNT_0)
    }
    #[doc = "Double component per clock cycle (a pixel per clock cycle)"]
    #[inline]
    pub fn mipi_double_cmpnt_1(self) -> &'a mut W {
        self.variant(MIPI_DOUBLE_CMPNTW::MIPI_DOUBLE_CMPNT_1)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = r" Proxy"]
pub struct _MIPI_YU_SWAPW<'a> {
    w: &'a mut W,
}
impl<'a> _MIPI_YU_SWAPW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = "Values that can be written to the field `DATA_FROM_MIPI`"]
pub enum DATA_FROM_MIPIW {
    #[doc = "Data from parallel sensor"]
    DATA_FROM_MIPI_0,
    #[doc = "Data from MIPI"]
    DATA_FROM_MIPI_1,
}
impl DATA_FROM_MIPIW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _bits(&self) -> bool {
        match *self {
            DATA_FROM_MIPIW::DATA_FROM_MIPI_0 => false,
            DATA_FROM_MIPIW::DATA_FROM_MIPI_1 => true,
        }
    }
}
#[doc = r" Proxy"]
pub struct _DATA_FROM_MIPIW<'a> {
    w: &'a mut W,
}
impl<'a> _DATA_FROM_MIPIW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: DATA_FROM_MIPIW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    #[doc = "Data from parallel sensor"]
    #[inline]
    pub fn data_from_mipi_0(self) -> &'a mut W {
        self.variant(DATA_FROM_MIPIW::DATA_FROM_MIPI_0)
    }
    #[doc = "Data from MIPI"]
    #[inline]
    pub fn data_from_mipi_1(self) -> &'a mut W {
        self.variant(DATA_FROM_MIPIW::DATA_FROM_MIPI_1)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = r" Proxy"]
pub struct _LINE_STRIDE_ENW<'a> {
    w: &'a mut W,
}
impl<'a> _LINE_STRIDE_ENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    #[doc = "Bit 20 - Double component per clock cycle in YUV422 formats."]
    #[inline]
    pub fn mipi_double_cmpnt(&self) -> MIPI_DOUBLE_CMPNTR {
        MIPI_DOUBLE_CMPNTR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 20;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        })
    }
    #[doc = "Bit 21 - It only works in MIPI CSI YUV422 double component mode."]
    #[inline]
    pub fn mipi_yu_swap(&self) -> MIPI_YU_SWAPR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 21;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
    pub fn data_from_mipi(&self) -> DATA_FROM_MIPIR {
        DATA_FROM_MIPIR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 22;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        })
    }
    #[doc = "Bit 24 - When the line width are not the multiple of the burst length, assert this bit."]
    #[inline]
    pub fn line_stride_en(&self) -> LINE_STRIDE_ENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 24;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        };
        LINE_STRIDE_ENR { bits }
    }
    #[doc = "Bits 25:30 - Image Data Format"]
    #[inline]
    pub fn mipi_data_format(&self) -> MIPI_DATA_FORMATR {
        let bits = {
            const MASK: u8 = 63;
            const OFFSET: u8 = 25;
            ((self.bits >> OFFSET) & MASK as u32) as u8
        };
        MIPI_DATA_FORMATR { bits }
    }
...
impl W {
    ...
    #[doc = "Bit 20 - Double component per clock cycle in YUV422 formats."]
    #[inline]
    pub fn mipi_double_cmpnt(&mut self) -> _MIPI_DOUBLE_CMPNTW {
        _MIPI_DOUBLE_CMPNTW { w: self }
    }
    #[doc = "Bit 21 - It only works in MIPI CSI YUV422 double component mode."]
    #[inline]
    pub fn mipi_yu_swap(&mut self) -> _MIPI_YU_SWAPW {
        _MIPI_YU_SWAPW { w: self }
    }
    #[doc = "Bit 22 - no description available"]
    #[inline]
    pub fn data_from_mipi(&mut self) -> _DATA_FROM_MIPIW {
        _DATA_FROM_MIPIW { w: self }
    }
    #[doc = "Bit 24 - When the line width are not the multiple of the burst length, assert this bit."]
    #[inline]
    pub fn line_stride_en(&mut self) -> _LINE_STRIDE_ENW {
        _LINE_STRIDE_ENW { w: self }
    }
    #[doc = "Bit 31 - CSI global enable signal"]
    #[inline]
