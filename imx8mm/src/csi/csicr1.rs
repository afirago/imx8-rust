...
#[doc = "Possible values of the field `VIDEO_MODE`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum VIDEO_MODER {
...
impl VIDEO_MODER {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            VIDEO_MODER::VIDEO_MODE_0 => false,
            VIDEO_MODER::VIDEO_MODE_1 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> VIDEO_MODER {
        match value {
            false => VIDEO_MODER::VIDEO_MODE_0,
            true => VIDEO_MODER::VIDEO_MODE_1,
        }
    }
    #[doc = "Checks if the value of the field is `VIDEO_MODE_0`"]
    #[inline]
    pub fn is_video_mode_0(&self) -> bool {
        *self == VIDEO_MODER::VIDEO_MODE_0
    }
    #[doc = "Checks if the value of the field is `VIDEO_MODE_1`"]
    #[inline]
    pub fn is_video_mode_1(&self) -> bool {
        *self == VIDEO_MODER::VIDEO_MODE_1
    }
}
...
#[doc = "Values that can be written to the field `VIDEO_MODE`"]
pub enum VIDEO_MODEW {
    #[doc = "Progressive mode is selected"]
    VIDEO_MODE_0,
    #[doc = "Interlace mode is selected"]
    VIDEO_MODE_1,
...
impl VIDEO_MODEW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            VIDEO_MODEW::VIDEO_MODE_0 => false,
            VIDEO_MODEW::VIDEO_MODE_1 => true,
        }
    }
}
#[doc = r" Proxy"]
pub struct _VIDEO_MODEW<'a> {
    w: &'a mut W,
}
impl<'a> _VIDEO_MODEW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: VIDEO_MODEW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    #[doc = "Progressive mode is selected"]
    #[inline]
    pub fn video_mode_0(self) -> &'a mut W {
        self.variant(VIDEO_MODEW::VIDEO_MODE_0)
    }
    #[doc = "Interlace mode is selected"]
    #[inline]
    pub fn video_mode_1(self) -> &'a mut W {
        self.variant(VIDEO_MODEW::VIDEO_MODE_1)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    #[doc = "Bit 27 - Video mode select. This bit controls the video mode in CCIR mode."]
    #[inline]
    pub fn video_mode(&self) -> VIDEO_MODER {
        VIDEO_MODER::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 27;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 27 - Video mode select. This bit controls the video mode in CCIR mode."]
    #[inline]
    pub fn video_mode(&mut self) -> _VIDEO_MODEW {
        _VIDEO_MODEW { w: self }
    }
    #[doc = "Bit 28 - CSI-PrP Interface Enable"]
    #[inline]
