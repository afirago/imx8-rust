...
impl R {
    ...
    #[doc = "Bits 0:5 - Post divider divide number Divider value is n + 1"]
    #[inline]
    ...
    #[doc = "Bits 16:18 - Pre divide divide number Divider value is n+1 This field does not apply for CORE, DRAM, DRAM_PHYM"]
    #[inline]
