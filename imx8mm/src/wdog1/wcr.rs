...
impl R {
    ...
    #[doc = "Bit 1 - Watchdog DEBUG Enable"]
    #[inline]
    ...
    #[doc = "Bit 3 - WDOG_B Time-out assertion"]
    #[inline]
    ...
    #[doc = "Bit 4 - Software Reset Signal"]
    #[inline]
    ...
    #[doc = "Bit 5 - WDOG_B assertion. Controls the software assertion of the WDOG_B signal."]
    #[inline]
    ...
    #[doc = "Bit 6 - Software Reset Extension. Required to be set to 1 when used in conjunction with the Software Reset Signal (SRS)."]
    #[inline]
    ...
    #[doc = "Bit 7 - Watchdog Disable for Wait"]
    #[inline]
    ...
    #[doc = "Bits 8:15 - Watchdog Time-out Field"]
    #[inline]
    pub fn wt(&self) -> WTR {
        WTR::_from({
            const MASK: u8 = 255;
