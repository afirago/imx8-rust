...
impl R {
    ...
    #[doc = "Bit 1 - Timeout. Indicates whether the reset is the result of a WDOG timeout."]
    #[inline]
    ...
    #[doc = "Bit 4 - Power On Reset. Indicates whether the reset is the result of a power on reset."]
    #[inline]
