...
impl R {
    ...
    #[doc = "Bits 0:7 - Watchdog Interrupt Count Time-out (WICT) field determines, how long before the counter time-out must the interrupt occur"]
    #[inline]
    ...
    #[doc = "Bit 14 - Watchdog Timer Interrupt Status bit will reflect the timer interrupt status, whether interrupt has occurred or not"]
    #[inline]
    ...
    #[doc = "Bit 15 - Watchdog Timer Interrupt enable bit"]
    #[inline]
