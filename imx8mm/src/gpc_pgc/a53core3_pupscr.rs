...
impl R {
    ...
    #[doc = "Bits 0:5 - After a power-up request (pup_req assertion), the PGC waits a number of clocks equal to the value of SW before asserting switch_b SW must not be programmed to zero"]
    #[inline]
    pub fn sw(&self) -> SWR {
        let bits = {
            const MASK: u8 = 63;
