...
impl super::AUDIO_PLL1_GEN_CTRL {
...
impl R {
    ...
    #[doc = "Bit 12 - Override the PLL_CLKE, clock gating enable signal from CCM"]
    #[inline]
    ...
    #[doc = "Bit 13 - PLL output clock clock gating enable"]
    #[inline]
    ...
    #[doc = "Bit 16 - PLL analog block bypass, clock output traces to PLL source"]
    #[inline]
