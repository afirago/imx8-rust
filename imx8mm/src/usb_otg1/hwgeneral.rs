...
impl R {
    ...
    #[doc = "Bits 4:5 - Data width of the transciever connected to the controller core"]
    #[inline]
    ...
    #[doc = "Bits 6:8 - Transciever type PHYM bit reset value: '0000b' for OTG controller core, '0100b' for Host-only controller core"]
    #[inline]
    ...
    #[doc = "Bits 9:10 - Serial interface mode capability SM bit reset value is '00b'"]
    #[inline]
    pub fn sm(&self) -> SMR {
        SMR::_from({
            const MASK: u8 = 3;
