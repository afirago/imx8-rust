...
impl R {
    ...
    #[doc = "Bits 0:7 - The start dealy cell point when send first CMD19 in tuning procedure."]
    #[inline]
    ...
    #[doc = "Bits 8:15 - The MAX repeat CMD19 times in tuning procedure."]
    #[inline]
    ...
    #[doc = "Bits 16:18 - The increasing delay cell steps in tuning procedure."]
    #[inline]
    ...
    #[doc = "Bits 20:22 - Select data window value for auto tuning"]
    #[inline]
    ...
    #[doc = "Bit 24 - Standard tuning circuit and procedure enable: This bit is used to enable standard tuning circuit and procedure"]
    #[inline]
