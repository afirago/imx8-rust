...
impl R {
    ...
    #[doc = "Bits 3:6 - The delay target for the uSDHC loopback read clock can be programmed in 1/16th increments of an ref_clock half-period"]
    #[inline]
    ...
    #[doc = "Bit 7 - Set this bit to 1 to prevent the DLL from updating (since when clock_in exists, glitches may appear during DLL updates)"]
    #[inline]
    ...
    #[doc = "Bit 8 - Set this bit to 1 to Enable manual override for slave delay chain using SLV_OVERRIDE_VAL; to set 0 to disable manual override"]
    #[inline]
    ...
    #[doc = "Bits 9:15 - When SLV_OVERRIDE = 1 This field is used to select 1 of 128 physical taps manually"]
    #[inline]
    ...
    #[doc = "Bits 16:18 - Refer to DLL_CTRL_SLV_DLY_TARGET0 below."]
    #[inline]
