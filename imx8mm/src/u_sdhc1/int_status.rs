...
impl R {
    ...
    #[doc = "Bit 12 - Re-Tuning Event: (only for SD3.0 SDR104 mode)"]
    #[inline]
    ...
    #[doc = "Bit 14 - Tuning Pass:(only for SD3.0 SDR104 mode)"]
    #[inline]
    pub fn tp(&self) -> TPR {
        let bits = {
            const MASK: bool = true;
    ...
    #[doc = "Bit 26 - Tuning Error: (only for SD3.0 SDR104 mode)"]
    #[inline]
